d3.svgRibbon = function() {
	...
	var _interpolator =d3.curveBasisClosed;

	function _ribbon(pathData) {

		var bothPoints = buildRibbon(pathData);

		return _lineConstructor.x(function (d) {return d.x}).y(function (d) {return d.y}).curve(_interpolator)(bothPoints);
	}
